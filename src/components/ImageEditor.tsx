      ...
      >
        {!imgElement && (
          <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-400 pointer-events-none p-6 text-center">
            ...
            <p className="text-lg font-semibold text-gray-600">Za začetek naloži sliko</p>
            <p className="text-sm text-gray-400 mt-2">Tvoji fotografiji bomo dodali sporočilo o podpori zakona o dostojni smrti.</p>
          </div>
        )}
        <canvas 
          ref={canvasRef} 
